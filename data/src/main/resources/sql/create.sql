...
CREATE TABLE CLIENTS
  (
    ...
    CONSTRAINT CLIENTS_EMPLOYEES_FK FOREIGN KEY ( ID_EMPLOYEE ) 
    	REFERENCES EMPLOYEES ( ID ) ON DELETE CASCADE ,
    CONSTRAINT CLIENTS_PEOPLES_FK FOREIGN KEY ( ID_PEOPLE ) 
...
CREATE TABLE COMMENTS
  (
    ...
    CONSTRAINT COMMENTS_PEOPLES_FK FOREIGN KEY ( ID_PEOPLE ) 
    	REFERENCES PEOPLES ( ID ) ON DELETE CASCADE ,
	CONSTRAINT COMMENTS_HOTELS_FK FOREIGN KEY ( ID_HOTEL ) 
		REFERENCES HOTELS ( ID ) ON DELETE CASCADE ,
	CONSTRAINT COMMENTS_OFFICES_FK FOREIGN KEY ( ID_OFFICE )
		REFERENCES OFFICES ( ID ) ON DELETE CASCADE ,
	CONSTRAINT COMMENTS_PLACES_FK FOREIGN KEY ( ID_PLACE ) 
...
CREATE TABLE CONTACTS
  (
    ...
    CONSTRAINT CONTACTS_LOCATIONS_FK FOREIGN KEY ( ID_LOCATION ) 
...
CREATE TABLE EMPLOYEES
  (
    ...
    CONSTRAINT EMPLOYEES_CURRENCY_FK FOREIGN KEY ( ID_CURRENCY ) 
    	REFERENCES CURRENCY ( ID ) ON DELETE CASCADE ,
    CONSTRAINT EMPLOYEES_OFFICES_FK FOREIGN KEY ( ID_OFFICE ) 
    	REFERENCES OFFICES ( ID ) ON DELETE CASCADE ,
	CONSTRAINT EMPLOYEES_PEOPLES_FK FOREIGN KEY ( ID_PEOPLE ) 
		REFERENCES PEOPLES ( ID ) ON DELETE CASCADE ,
...
CREATE TABLE FLIGHTS
  (
    ...
    CONSTRAINT FLIGHTS_CURRENCY_FK FOREIGN KEY ( ID_CURRENCY ) 
    	REFERENCES CURRENCY ( ID ) ON DELETE CASCADE ,
	CONSTRAINT FLIGHTS_LOCATIONS_FK FOREIGN KEY ( ID_LOCATION_FROM ) 
		REFERENCES LOCATIONS ( ID ) ON DELETE CASCADE ,
	CONSTRAINT FLIGHTS_LOCATIONS_FKv1 FOREIGN KEY ( ID_LOCATION_TO ) 
		REFERENCES LOCATIONS ( ID ) ON DELETE CASCADE ,
	CONSTRAINT FLIGHTS_TOUR_FK FOREIGN KEY ( ID_TOUR ) 
...
CREATE TABLE FOOD
  (
    ...
    CONSTRAINT FOOD_CURRENCY_FK FOREIGN KEY ( ID_CURRENCY ) 
    	REFERENCES CURRENCY ( ID ) ON DELETE CASCADE,
    CHECK ( PRICE > 0 ) ,
...
CREATE TABLE HOTELS
  (
	...
	CONSTRAINT HOTELS_LOCATIONS_FK FOREIGN KEY ( ID_LOCATION ) 
		REFERENCES LOCATIONS ( ID ) ON DELETE CASCADE ,
	CONSTRAINT HOTELS_TOUR_FK FOREIGN KEY ( ID_TOUR ) 
		REFERENCES TOURS ( ID ) ON DELETE CASCADE ,
...
CREATE TABLE OFFICES
  (
    ...
    CONSTRAINT OFFICES_CONTACTS_FK FOREIGN KEY ( ID_CONTACT ) 
...
CREATE TABLE PEOPLES
  (
	...
	CONSTRAINT PEOPLES_CONTACTS_FK FOREIGN KEY ( ID_CONTACT ) 
		REFERENCES CONTACTS ( ID ) ON DELETE CASCADE 
  ) ;
...
CREATE TABLE PHOTO
  (
    ...
    CONSTRAINT PHOTO_HOTELS_FK FOREIGN KEY ( ID_HOTEL ) 
    	REFERENCES HOTELS ( ID ) ON DELETE CASCADE ,
	CONSTRAINT PHOTO_PEOPLES_FK FOREIGN KEY ( ID_PEOPLE ) 
		REFERENCES PEOPLES ( ID ) ON DELETE CASCADE ,
	CONSTRAINT PHOTO_PLACES_FK FOREIGN KEY ( ID_PLACE ) 
		REFERENCES PLACES ( ID ) ON DELETE CASCADE 
  ) ;
...
CREATE TABLE PLACEMENT
  (
	...
	CONSTRAINT PLACEMENT_CURRENCY_FK FOREIGN KEY ( ID_CURRENCY ) 
		REFERENCES CURRENCY ( ID ) ON DELETE CASCADE 
  ) ;
...
CREATE TABLE PLACES
  (
	...
	CONSTRAINT PLACES_LOCATIONS_FK FOREIGN KEY ( ID_LOCATION ) 
		REFERENCES LOCATIONS ( ID ) ON DELETE CASCADE ,
	CONSTRAINT PLACES_PLACES_FK FOREIGN KEY ( ID_PLACE ) 
		REFERENCES PLACES ( ID ) ON DELETE CASCADE ,
    CHECK ( ID <> ID_PLACE )
  ) ;
...
CREATE TABLE ROOMS
  (
	...
	CONSTRAINT ROOMS_FOOD_FK FOREIGN KEY ( ID_FOOD ) 
		REFERENCES FOOD ( ID ) ON DELETE CASCADE ,
	CONSTRAINT ROOMS_HOTELS_FK FOREIGN KEY ( ID_HOTEL ) 
		REFERENCES HOTELS ( ID ) ON DELETE CASCADE ,
	CONSTRAINT ROOMS_PLACEMENT_FK FOREIGN KEY ( ID_PLACEMENT ) 
...
CREATE TABLE TRAVELS
  (
	...
	CONSTRAINT TRAVELS_CLIENTS_FK FOREIGN KEY ( ID_CLIENT ) 
		REFERENCES CLIENTS ( ID ) ON DELETE CASCADE ,
	CONSTRAINT TRAVEL_TOUR_FK FOREIGN KEY ( ID_TOUR ) 
		REFERENCES TOURS ( ID ) ON DELETE CASCADE 
  ) ;
...
(
	...
	CONSTRAINT TOUR_OFFICE_FK FOREIGN KEY ( ID_OFFICE ) 
		REFERENCES OFFICES ( ID ) ON DELETE CASCADE,
	CONSTRAINT TOUR_PLACE_FK FOREIGN KEY ( ID_PLACE ) 
		REFERENCES PLACES ( ID ) ON DELETE CASCADE
);
...
(
	...
	CONSTRAINT USER_PEOPLE_FK FOREIGN KEY ( ID_PEOPLE ) 
		REFERENCES PEOPLES ( ID ) ON DELETE CASCADE
);
...
DROP INDEX FLIGHT_ID_TOUR_INDEX;

DROP INDEX HOTEL_ID_TOUR_INDEX;

DROP INDEX TOUR_ID_PLACE_INDEX;

DROP INDEX TRAVEL_ID_TOUR_INDEX;

CREATE INDEX FLIGHT_ID_TOUR_INDEX ON FLIGHTS( ID_TOUR );

CREATE INDEX HOTEL_ID_TOUR_INDEX ON HOTELS( ID_TOUR );

CREATE INDEX TOUR_ID_PLACE_INDEX ON TOURS( ID_PLACE );

CREATE INDEX TRAVEL_ID_TOUR_INDEX ON TRAVELS( ID_TOUR );